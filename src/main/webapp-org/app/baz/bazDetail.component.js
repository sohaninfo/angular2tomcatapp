...
var BazDetailsComponent = (function () {
    function BazDetailsComponent() {
    }
    BazDetailsComponent = __decorate([
        core_1.Component({
            selector: 'baz-detail',
            template: template,
    ...
    return BazDetailsComponent;
}());
exports.BazDetailsComponent = BazDetailsComponent;
//# sourceMappingURL=bazDetail.component.js.map